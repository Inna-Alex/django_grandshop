...
urlpatterns = [
    ...
    url(r'^manufactor/create/$', views.ManufactorCreate.as_view(),
        name='manufactor_create'),
    url(r'^manufactor/(?P<pk>\d+)/update/$', views.ManufactorUpdate.as_view(),
        name='manufactor_update'),
    url(r'^manufactor/(?P<pk>\d+)/delete/$', views.ManufactorDelete.as_view(),
    ...
    url(r'^category/create/$', views.CategoryCreate.as_view(),
        name='category_create'),
    url(r'^category/(?P<pk>\d+)/update/$', views.CategoryUpdate.as_view(),
        name='category_update'),
    url(r'^category/(?P<pk>\d+)/delete/$', views.CategoryDelete.as_view(),
    ...
    url(r'^item/(?P<pk>[-\w]+)/update/$', views.ItemUpdate.as_view(),
        name='item_update'),
    url(r'^item/(?P<pk>[-\w]+)/delete/$', views.ItemDelete.as_view(),
        name='item_delete'),

    url(r'^orders/$', views.OrderListView.as_view(), name='orders'),
    url(r'^order/(?P<pk>[-\w]+)$', views.show_order_detail_form,
        name='order_detail'),
    ...
    url(r'^remove_items/', views.remove_order_detail_items,
        name="remove_items"),
    ...
    url(r'^order/(?P<pk>[-\w]+)/update/$', views.OrderUpdate.as_view(),
        name='order_update'),
    ...
    url(r'^orderitem/(?P<pk>[-\w]+)/delete/$', views.OrderItemDelete.as_view(),
