...
class ManufactorModelTest(TestCase):
    ...
    def test_get_absolute_url(self):
        manufactor=Manufactor.objects.get(manufactor_id=1)
        self.assertEquals(manufactor.get_absolute_url(),'/catalog/manufactor/1')
...
class ItemModelTest(TestCase):
    ...
    def setUp(self):
        ...
        Item.objects.create(item_id=self.item_uuid, manufactor=manufactor, category=category,
    ...
    def test_get_absolute_url(self):
        item=Item.objects.get(item_id=self.item_uuid)
        self.assertEquals(item.get_absolute_url(), '/catalog/item/' + str(self.item_uuid))
