# Generated by Django 3.1 on 2020-09-23 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_date', models.DateField(default=datetime.date(2020, 9, 28), help_text='Дата доставки заказа', verbose_name='Дата доставки')),
        ...
        migrations.AddIndex(
            model_name='order',
            index=models.Index(fields=['created_date'], name='catalog_ord_created_af9085_idx'),
        ),
        migrations.AddIndex(
            model_name='item',
